package com.pedro.opencv.algorithms;
...
import com.pedro.opencv.constants.Constants;
import com.pedro.opencv.gui.ImagePanel;
...
public class FaceDetection {
	...
	public void detectFaces(File file, ImagePanel imagePanel) {
		...
		cascadeClassifier.detectMultiScale(image, faceDetections, 1.05, 4, 10, new Size(20,20), new Size(500,500));
